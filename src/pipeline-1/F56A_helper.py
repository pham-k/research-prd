...
def F56_NGAY():
    ...
    df['F56_NGAY'] = pd.to_datetime(df['F56_NGAY']).dt.strftime('%Y-%m-%d')
    return df
...
def F56A1():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A1
    """
    df = (TK
        .query('LanTK == 6.0')
        [['V1', 'DauBungTS']]
...
def F56A1A():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A1A
    """
    ...
    df['F56A1A'] = df.apply(util.concatenate_columns, axis=1)
...
def F56A2():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A2
    """
    df = (TK
        .query('LanTK == 6.0')
        [['V1', 'OiTS']]
...
def F56A2A():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A2A
    """
    ...
    df['F56A2A'] = df.apply(util.concatenate_columns, axis=1)
    df.drop(columns=cols, inplace=True)
    df.drop_duplicates(subset=['MANC'], inplace=True)
    return df
...
def F56A3A():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A3A
    """
    df = (TK.query('LanTK == 6.0')
        [['V1', 'TaoBon']]
        .rename(columns={
...
def F56A3B():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A3B
    """
    df = (TK.query('LanTK == 6.0')
        [['V1', 'Bristol']]
        .rename(columns={
...
def F56A4():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A4
    """
    df = (TK.query('LanTK == 6.0')
        [['V1', 'TDCanNang']]
        .rename(columns={
...
def F56A5():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A5
    """
    ...
    df['F56A5'] = df.apply(util.concatenate_columns, axis=1)
    df.drop(columns=cols, inplace=True)
    df.drop_duplicates(subset=['MANC'], inplace=True)
    return df
...
def F56A8():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A8
    """
    df = (TK.query('LanTK == 6.0')
        [['V1', 'ChieuCao']]
        .rename(columns={
...
def F56A9():
    ...
    Returns:
        DataFrame contains 2 columns MANC, F56A9
    """
    df = (TK.query('LanTK == 6.0')
        [['V1', 'CanNang']]
        .rename(columns={
